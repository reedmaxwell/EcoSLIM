...
!$OMP PARALLEL DO PRIVATE(Ploc,ii,k,l,ik,Clocx, Clocy, Clocz,Vpx)  &
!$OMP& PRIVATE(Vpy, Vpz,z,particledt, delta_time,local_flux, et_flux, water_vol, Zr)
    do ii = 1, np_active
      !!!!!!!!!!!!!!!!!!
      !!!!!!!!!!!!!!!!!!
      !!!  Move Particles Section
      !!!!!!!!!!!!!!!!!!
      !!!!!!!!!!!!!!!!!!
