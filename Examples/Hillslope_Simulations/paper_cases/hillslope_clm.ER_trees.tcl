#  This runs the ER trees PF-CLM hillslope simulation
...
file mkdir hillslope_clm_ER_trees
cd hillslope_clm_ER_trees

## copy CLM input files
file copy -force ../clm_input/drv_clmin.dat .
file copy -force ../clm_input/drv_vegm.trees.dat drv_vegm.dat
...
pfrun hillslope_clm_ER_trees
pfundist hillslope_clm_ER_trees
cd ..
